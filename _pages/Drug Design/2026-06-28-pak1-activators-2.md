...
- **图S5C-D**：MM/GBSA自由能分解分别识别PAK1-A1（C）和NVS-PAK1-1（D）结合全长PAK1时的关键残基，灰色标注表示两类配体共享的接触残基。关键差异是PAK1-A1对kinase inhibitory segment（aa 136-149）区域有显著的能量贡献，说明它直接结合并占据了KIS原本的位置，而NVS-PAK1-1主要结合DFG motif——这解释了两者为什么占据重叠位点却产生相反功能
