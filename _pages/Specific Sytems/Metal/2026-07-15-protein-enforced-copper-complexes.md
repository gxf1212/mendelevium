...
- **第二，高配位数Cu(I)的匮乏**。Cu(I)为$\ce{d^{10}}$闭壳层构型，理论上不具备配体场稳定化能的驱动力。更重要的是，Cu(I)倾向于四配位四面体几何构型，配位数达到六往往伴随配体解离和配合物分解。Cu(I)的$\ce{d^{10}}$构型无配体场稳定化能，且**Cu(I)在含水溶液中天然倾向歧化为Cu(II)和Cu(0)**。
...
| 蛋白质 | 对称性 | 母体蛋白质 | 突变位点 | Cβ-Cβ距离 |
|--------|--------|-----------|---------|-----------|
| **DP1** | C<sub>2</sub> | DTDP-6-deoxy-D-xylo-4-hexulose 3,5-epimerase | R79Z | 6.6 Å |
| **DP2** | C<sub>2</sub> | 同上 | R46Z | 8.3 Å |
| **TP1** | C<sub>3</sub> | GlnK（氮敏感调控蛋白） | S31Z | 6.8 Å |
| **TP6** | C<sub>3</sub> | Phosphosulfolactate synthase | K26Z | 7.9 Å |
