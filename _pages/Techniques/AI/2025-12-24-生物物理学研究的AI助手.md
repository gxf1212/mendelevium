...
#### 1. Reference MCP [[https://github.com/ndchikin/reference-mcp](https://github.com/ndchikin/reference-mcp)]
...
#### 2. PubMed MCP [[https://github.com/andybrandt/mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)]
...
#### 3. arXiv MCP [[https://github.com/blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)]
...
#### 4. AlphaFold MCP [[https://github.com/Augmented-Nature/AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)]
...
#### 5. UniProt MCP [[https://github.com/TakumiY235/uniprot-mcp-server](https://github.com/TakumiY235/uniprot-mcp-server)]
...
#### 6. PubChem MCP [[https://github.com/Augmented-Nature/PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)]
...
#### 7. Context7 [[https://www.npmjs.com/package/@context7/mcp-server](https://www.npmjs.com/package/@context7/mcp-server)]
...
#### 8. Serena [[https://github.com/oraios/serena](https://github.com/oraios/serena)]
...
配置好 MCP 服务器后，AI 能直接访问 PubMed、AlphaFold 等数据库，完成从文献搜索到结构预测的串联操作。对日常研究来说，效果最明显的几点：

1. **文献调研时间缩短**：从数天手动检索缩短到数小时的 AI 辅助整理
2. **数据获取准确**：直接从数据库拉取，避免手动抄录错误
3. **计算假设验证更快**：结果出来直接对接 MCP 调用下一步
4. **API 文档不用查**：AI 自动调用 Context7 等工具查询最新用法

MCP 生态系统还在快速变化，更多专业工具以后会以服务器形式出现。当前阶段，配置好上面列出的几个就能覆盖大部分日常使用场景。
