...
- 加粗要表达完整意思、观点，一般不是单个词、短语、数据。避免像**数据效率高**、**温度范围**、**副本数**这种短语加粗，应该改为表达完整观点的加粗，如**CV-FEST框架的核心优势是数据效率高**、**温度范围覆盖折叠到展开态**、**使用25个温度副本进行采样**。
  ...
  - 比加粗更要突出的整段punchline或关键概念，升级用引用块（见 `04-ai-writing-and-quote-blocks.md`）——强调层级是：普通重点加粗 → 最核心结论用引用块。
