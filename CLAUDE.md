...
处理项目理念、技术栈、栏目、frontmatter、文件命名、新文章元数据时，必须读这些：
...
“修格式”、“中文标点”、“加粗”、“列表”、“去AI味”、“检查全文格式”时，必须读这些：
